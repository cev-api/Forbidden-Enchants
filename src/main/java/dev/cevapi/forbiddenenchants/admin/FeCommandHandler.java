...
final class FeCommandHandler implements CommandExecutor, TabCompleter {
    ...
    private final EnchantingTableInjectorCommandHandler enchantingTableInjectorCommandHandler;
    ...
    FeCommandHandler(@NotNull ForbiddenEnchantsPlugin plugin) {
        ...
        this.enchantingTableInjectorCommandHandler = new EnchantingTableInjectorCommandHandler(plugin);
    ...
    public boolean onCommand(@NotNull CommandSender sender,
        ...
        return switch (args[0].toLowerCase(Locale.ROOT)) {
            ...
            case "enchanting", "enchantingtable", "enchanttable" -> enchantingTableInjectorCommandHandler.handleCommand(sender, args);
    ...
    public @NotNull List<String> onTabComplete(@NotNull CommandSender sender,
        ...
        boolean isEnchanting = args[0].equalsIgnoreCase("enchanting")
                || args[0].equalsIgnoreCase("enchantingtable")
                || args[0].equalsIgnoreCase("enchanttable");
        ...
        if (isEnchanting) {
            return enchantingTableInjectorCommandHandler.tabComplete(args);
        }
        if (isBundle) {
